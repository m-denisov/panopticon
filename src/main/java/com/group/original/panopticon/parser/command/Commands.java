...
public class Commands {
    ...
    public static final Command OPEN_COPY = new PathCommand();

    /**Researcher**/
    public static final Command COMPARE = new PathCommand();
    public static final Command COMPARE_LAZY = new PathCommand();
    public static final Command GET_CHANGES = new PathCommand();
    public static final Command MAKE_STAMP = new PathCommand();
    public static final Command IS_SAVE = new PathCommand();
}
