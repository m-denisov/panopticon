...
public class Commands {
    /**Main**/
    public static final Command<Content> BREAK = new CommentCommand();
    public static final Command<Content> EXIT = new CommentCommand();
//    public static final Command WAIT = new CommentCommand();
    public static final Command<Content> REPORT = new CommentCommand();
    public static final Command<Content> REPORT_AND_WAIT = new CommentCommand();
    public static final Command<Content> INFO = new CommentCommand();
    public static final Command<Content> COMMAND_INFO = new CommentCommand();
